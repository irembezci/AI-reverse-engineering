...
| Dosya | Açıklama |
|--------|----------|
| `black-box-problemi.md` | Black-box problemini AI güvenliği perspektifinden ele alan teknik inceleme |
| `RE-sureci-sorular.md` | AI model reverse engineering sürecinde sorulması gereken temel sorular ve analiz yaklaşımı |
